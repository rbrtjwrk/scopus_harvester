...
Call function _scopus_journals(subject, count)_ to obtain all of the attributes at once. List of all subject areas can be found at https://dev.elsevier.com/.
