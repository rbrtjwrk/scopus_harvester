...
Although it is possible to call standalone functions separately, I recommend you to call function _scopus_journals(subject_abbrev=None, count=None)_ to obtain all of the attributes at once.\
